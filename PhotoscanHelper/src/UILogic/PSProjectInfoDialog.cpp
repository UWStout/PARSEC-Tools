...
void PSProjectInfoDialog::setProjectData(const PSSessionData* pProjData) {
    //TODO: Create local PSProjectFileData variable to parse information from XML file
    QString mainHeader;
    ...
    PSProjectFileData* lProjData = new PSProjectFileData(pProjData->getPSProjectFile());
