...
class ImageProcessorIM4J {
public:
    static double mMultipliers[4];

    static void setSearchPath(QString newPath);
    static void setExiftoolOverrideBin(QString newExiftoolBin);
    static void setDcrawOverrideBin(QString newDcrawBin);
    static void setImageMagickOverrideBin(QString newImageMagickBin);
    static void setUseGraphicsMagick(bool useGM);
    static QString getSearchPath();
    static QString getExiftoolOverrideBin();
    static QString getDcrawOverrideBin();
    static QString getImageMagickOverrideBin();
    static bool getUseGraphicsMagick();
    static bool locatePrograms();
    static QFile developRawImage(QFile pImageFile, /*ExposureSettings pSettings,*/ bool pAsPreview);
    static bool compressTIFF(QFile pImageFile);
    static bool copyMetadataTags(QFile pDestinationFile, QFile pSourceFile);
    static QDate getDateFromMetadata(QFile pImageFile);

private:
    static bool USE_GRAPHICS_MAGICK;
    static QString searchPath;
    static QString exifToolOverrideBin;
    static QString dcrawOverrideBin;
    static QString imageMagickOverrideBin;

    static void extractMultipliers(QString pS);
};
